...
<body>
  ...
  <nav class="navbars nav-container">
    ...
    <div class="container-plant para">
      <h3>Discover the magic within each seed, where potential takes root and blossoms into vibrant life in our plant nursery.</h3>
    </div>
...
<script src="<?php echo ROOT?>/public/assests/javascript/seeds.js"></script>