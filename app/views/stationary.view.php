...
<body>
  ...
  <nav class="navbars nav-container">
    ...
    <div class="container-plant para">
      <h3>Enhance your green space with our exquisite range of plant accessories, designed to complement and elevate the beauty of your botanical treasures.</h3>
    </div>
    <div class="posts-container" id="load-more">
    </div>
    <div class="button-container container-plant" style="display: none;">
        <button id="load-more-btn">Load More</button>
    </div>
</body>
</html>
<script src="<?php echo ROOT?>/public/assests/javascript/stationary.js"></script>